        ...
        while self.run_algorithm is True:
            ...
            for project in self.plc:
                if self.run_algorithm is False and self.plc[project][1] > 0 and self.plc[project][2] is True:
                    ...
                    print(project, self.plc[project], self.M)
                    ...
                    Q = self.lp[lecturer][1][position_worst_tie][:]  # deep copy of k worst students at the tail of L_k, including the last tie
                    print('Q-before', Q)
                    ...
                    if len(Q) > 0:
                        ...
                        # the following while loop is checking to see if l_k prefers or is indifferent between any student rejected from p_j and the students at its tail
